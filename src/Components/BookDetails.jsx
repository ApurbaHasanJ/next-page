        ...
        <div className=" p-8 bg-white lg:p-16 lg:pl-10 lg:w-1/2">
          ...
          {fold ? (
            <>
              ...
              <span onClick={() => setFold(!fold)} className="cursor-pointer text-blue-600  hover:underline">Read More</span>
            </>
          ) : (
            <>
              ...
              <span onClick={() => setFold(!fold)} className="cursor-pointer text-blue-600 hover:underline">Read Less</span>
            </>
          )}
